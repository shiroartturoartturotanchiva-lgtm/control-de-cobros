...
*   **Problema**: El uso de planillas físicas generaba falta de trazabilidad, errores en los saldos y la imposibilidad de consulta remota para el abonado.
...
*   `clientes`: Datos maestros de abonados.
